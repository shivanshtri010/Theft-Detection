# Shoplifting Detection with Machine Learning
...
### Usage
1. Preprocess the dataset: Run `theft_detection.ipynb` to preprocess the DCSASS dataset.
2. Train the model: Run `theft_detection.ipynb` to train the shoplifting detection model.
3. Evaluate the model: Run `theft_detection.ipynb` to evaluate the model's performance.
4. Make predictions: Use the trained model to make predictions on new video data using `theft_detection.ipynb`.
